...
const OTHER_QUIPS = [
  ...
  // Operations & quips
  'Whisky bottles open in The Rampant Room: 292 (and counting)',
  'The oat milk situation has been resolved',
  'Lost property: Miss Tran\'s tasteful cashmere scarf, Mr Minh\'s interesting gucci wallet',
  ...
  'The suggestion box has been emptied. Suggestions were... somewhat helpful?',
