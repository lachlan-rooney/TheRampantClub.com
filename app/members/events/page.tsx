...
import { DateBlock, KIND_META, dotOf, relativeDate, whatsOnCss, whatsOnNarrowCss } from '@/components/events/whats-on'
  ...
  return (
    <MemberPage title={surfaceName('/members/events', 'en')} subtitle={surfaceName('/members/events', 'vn')} art={art}>
      <style suppressHydrationWarning dangerouslySetInnerHTML={{ __html: `
        ...
        /* ── a line of the fixtures card — components/events/whats-on.tsx ── */
${whatsOnCss()}
