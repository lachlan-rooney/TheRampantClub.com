...
| **Floor** — what you need at the club: MX Daily (the morning brief), Tonight (service prep), Calendar (bookings), Shift Checklists (opening/closing handover), Harmony Log (end-of-shift AI capture), Notices. | **Floor** — những gì bạn cần tại câu lạc bộ: MX Daily (bản tóm tắt buổi sáng), Tonight (chuẩn bị phục vụ), Calendar (đặt chỗ), Shift Checklists (bàn giao mở/đóng ca), Harmony Log (ghi nhận cuối ca bằng AI), Notices. |
